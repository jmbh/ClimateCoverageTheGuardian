...
data_bin <- readRDS(file = paste0("Files/Guard_Df_binarized_rdy_", ai_handle, ".RDS"))
dim(data_bin)
...
# --------------------------------------------
# --------- Compute Broadly/Mainly -----------
# --------------------------------------------
# On the set with the three data quality filters
# These are the numbers we report in the methods section
# Broadly CC
tb <- table(data_bin_ss_no_BM$broadly_climate_change)
prop.table(tb) |> round(3)
# Mainly CC
...
saveRDS(data_bin_ss, file = paste0("Files/G_Df_bin_Filtered_broadly_", ai_handle, ".RDS"))
saveRDS(data_bin_ss_mainly, file = paste0("Files/G_Df_bin_Filtered_mainly_", ai_handle, ".RDS"))
saveRDS(data_bin_ss_no_BM, file = paste0("Files/G_Df_bin_Filtered_NoBM_", ai_handle, ".RDS"))
