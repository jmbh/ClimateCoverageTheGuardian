...
# Plotting PDF
sc <- 1
pdf(paste0("Figures/Fig_Correlational_Spearman_", filter, ".pdf"), width=10*sc, height=10*sc)
...
# Plotting PDF
sc <- 0.5
pdf(paste0("Figures/Fig_Correlational_OR_4x4_Spearman_", filter, ".pdf"), width=10*sc, height=10*sc)
...
# Plotting PDF
sc <- 0.5
pdf(paste0("Figures/Fig_Correlational_OR_4x4_Conditional_", filter, "_", ai_handle, ".pdf"), width=10*sc, height=10*sc)
